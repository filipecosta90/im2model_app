...
void CvImageFrameWidget::addRenderPoints( std::vector<cv::Point2i> points, int penWidth, std::vector<cv::Vec3b> penColor, QString description, cv::Point2i margin_point ){

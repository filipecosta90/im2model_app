...
bool SimGrid::export_sim_grid( std::string sim_grid_file_name_image ){
  ...
  if(
      ...
      // BaseCrystal vars
      _flag_slice_samples &&
      _flag_simulated_params_slice_vec  &&
      _flag_simulated_params_nm_slice_vec  &&
      _flag_defocus_samples &&
      _flag_simulated_params_nm_defocus_vec  &&
